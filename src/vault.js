// vault.js - handles loading of vault markdown content
...
const vaultFiles = import.meta.glob('../vault/*.md', { query: '?raw', import: 'default', eager: true });

/**
 * Get the content of a vault file by its filename
 * @param {string} filename - The filename (e.g. 'food.md') relative to vault/
 * @returns {string|null} The raw markdown content or null if not found
 */
export function getVaultContent(filename) {
