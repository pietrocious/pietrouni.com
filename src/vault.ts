...
export const vaultData: VaultItem[] = [
  ...
  /*
  {
    ...
    desc: "Cloud, Networking, DevOps tools & skills",
    items: [
      { name: "Compute: VMs, Auto Scaling, Load Balancing" },
      { name: "Networking: VPCs, DNS, CDN, Dedicated Interconnect" },
      { name: "Storage: Object, Block & File Storage" },
      { name: "Security: IAM, TLS Certs, Firewalls, Network ACLs" },
      { name: "Monitoring: Metrics, Audit Logs, Config Mgmt" },
      { name: "Databases: Managed SQL & NoSQL" },
